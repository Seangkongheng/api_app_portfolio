            ...
            <tbody>
                @foreach ($projects as $index => $project)
                    <tr>
                        ...
                        <td>
                            <a class="text-success mx-3" href="{{ route('project.edit', $project->id) }}">
                                <i class="fa-solid fa-pen-to-square"></i>
                            </a>
                            <button  style="border: none;background:none" class="text-danger btnDeleteUser" value="{{ $project->id }}" data-toggle="modal" data-target="#exampleModal">
