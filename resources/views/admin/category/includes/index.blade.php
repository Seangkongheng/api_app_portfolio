<div class="content-wrapper p-4 p-md-5">
        ...
        <div class="col-12">
            <div
                ...
                <h4 class="mb-0 d-flex align-items-center text-dark">
                    <i class="bi bi-list-ul me-2 text-info"></i> &nbsp; My Category
                </h4>
                <form class="d-flex flex-grow-1 mx-3" action="{{ route('experience.index') }}" method="GET"
                    style="max-width: 400px;">
                    <input type="text" name="search" class="form-control rounded-start" placeholder="Search Category..."
    ...
    @include('admin.category.partials.index')
</div>
</div>
