...
<div class="container mt-4">
    <div class="card shadow-lg border-0">
        ...
        <div class="card-body p-4">
            <h3 class="mb-3">{{ $Blog->title ?? "None" }}</h3>
                ...
                <div class="row text-sm">
                    ...
                    <div class="col-md-3 col-sm-6 mb-2">
                        <span class="d-inline-block w-100">
                            ...
                            <span class="badge bg-info">{{ $Blog->author ?? "None" }}</span>
                        </span>
                    </div>
                    ...
                    <div class="col-md-3 col-sm-6 mb-2">
                        <span class="d-inline-block w-100">
                            ...
                            <strong>Views:</strong> {{ $Blog->view ?? "0" }}
                        </span>
                    </div>
                    ...
                    <div class="col-md-3 col-sm-6 mb-2">
                        <span class="d-inline-block w-100">
                            ...
                            <span class="badge {{ $Blog->is_public === 1 ? 'bg-success' : 'bg-secondary' }}">
        ...
        <div class="card-footer bg-light text-end">
            <a href="{{ route('blog.edit', $Blog->id) }}" class="btn btn-outline-primary">✏️ Edit Post</a>
        </div>
    </div>
</div>
