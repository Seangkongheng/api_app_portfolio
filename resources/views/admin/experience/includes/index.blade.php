            ...
            <div class="col-12">
                <div class="bg-light rounded p-3 shadow-sm d-flex flex-wrap align-items-center justify-content-between gap-3">
                    ...
                    <h4 class="mb-0 d-flex align-items-center text-dark">
                         <i class="bi bi-list-ul me-2 text-info"></i> &nbsp; My Experience
                    </h4>
                    <form class="d-flex flex-grow-1 mx-3" action="{{ route('experience.index') }}" method="GET"
                        style="max-width: 400px;">
                        <input type="text" name="search" class="form-control rounded-start" placeholder="Search Experience..."
                    ...
                    <a href="{{ route('experience.create') }}" class="btn btn-info d-flex align-items-center">
